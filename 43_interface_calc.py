...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 225, 435)
        ...
        self.mod.move(170, 320)

        self.squaring = QPushButton('х²', self)
        self.squaring.resize(50, 50)
        self.squaring.move(115, 375)

        self.exact_div = QPushButton('//', self)
        self.exact_div.resize(50, 50)
        self.exact_div.move(170, 375)
        ...
        self.squaring.clicked.connect(self.squaring_1)
        self.exact_div.clicked.connect(self.exact_div_1)
